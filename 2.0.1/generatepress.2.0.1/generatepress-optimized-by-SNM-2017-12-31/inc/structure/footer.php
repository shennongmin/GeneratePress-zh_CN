...
if ( ! function_exists( 'generate_add_footer_info' ) ) {
	...
	function generate_add_footer_info() {
		...
		*/	
		...
		/* Add by SNM 20170603 { */
		$copyright = sprintf( '<span class="copyright"><a href="%1$s" itemprop="url" target="_blank">%2$s</a> &copy; %3$s</span> | <a href="%4$s" itemprop="url" target="_blank">%5$s</a>',
			esc_url( 'http://www.shennongmin.org' ),
			'神农民博客',
			date( 'Y' ),
			esc_url( 'http://www.miitbeian.gov.cn' ),
			'粤ICP备17086920号'
		);
		/* Add by SNM 20170603 } */
